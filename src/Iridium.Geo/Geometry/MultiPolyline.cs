...
{
    // public class MultiPolyline : MultiPoly, IMultiGeometry<Polyline>, ITransformable<MultiPolyline>, IIntersectable<Poly>, IIntersectable<Polyline>, IIntersectable<Polygon>
    // {
    //  //   public IReadOnlyList<Polyline> Polylines { get; }
    //
    //     public MultiPolyline(IEnumerable<Polyline> polylines) : base(polylines)
    //     {
